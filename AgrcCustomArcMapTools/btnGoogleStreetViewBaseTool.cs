...
{
    /// <summary>
    /// Summary description for btnGoogleStreetViewBaseTool.
    /// </summary>
    [Guid("56010cd9-a205-4cce-9c1c-50a7a0fc268d")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("AgrcCustomArcMapTools.btnGoogleStreetViewBaseTool")]
    public sealed class btnGoogleStreetViewBaseTool : BaseTool
    {
        ...
        public btnGoogleStreetViewBaseTool()
        {
            //
            ...
            base.m_name = "AgrcToolsGoogleStreetview";   //unique id, non-localizable (e.g. "MyCategory_ArcMapTool")
        ...
        {
            // TODO: Add btnGoogleStreetViewBaseTool.OnClick implementation
        }
        ...
        public override void OnMouseDown(int Button, int Shift, int X, int Y)
        {
            try
            {
                ...
                IMxDocument pMxDocument = clsAgrcArcMapExtension.m_application.Document as IMxDocument;
        ...
        {
            // TODO:  Add btnGoogleStreetViewBaseTool.OnMouseMove implementation
        }

        public override void OnMouseUp(int Button, int Shift, int X, int Y)
        {
            // TODO:  Add btnGoogleStreetViewBaseTool.OnMouseUp implementation
        }
        #endregion
    }
}
